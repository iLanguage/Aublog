...
var draftDefaultData = {
  ...
  children: [{
    ...
    hidden: "0",
    data: {
      content: "The drafts tree lets you visualize/listen to blog entries, and re-draft or re-wind until you are ready to publish. Each time you hit the save button, a new node is created. "
    },
    children: [{
      id: "5",
      ...
      hidden: "0",
      data: {
        content: "You can also simply type your blog entry by clicking on the Edit button."
      },
      children: []
    }]
  }]
...
function init(dataIn) {
  ...
  st = new $jit.ST({
    ...
    onBeforeCompute: function(node) {
      ...
      Android.setSelectedId(node.id, node.name);
    },
